...
function getSite(url, redisClient, callback) {
  console.log({site: site}, 'lib/helpers.js --- line 8')

  redisClient.get(url, function(err, links) {
    console.log({site: site}, 'lib/helpers.js --- line 11')
  ...
  console.log({site: site}, 'lib/helpers.js --- line 20')
...
function loadSites(sites) {
  ...
  async.eachSeries(siteArray, function (site, callback) {
    ...
    var url = `http://localhost:${port}/${site}`;
